    ...
    if (validateVacationsDate) {
      ...
      if (req.body.startDate) {
        req.body.startDate = new Date(
          new Date(req.body.startDate).setHours(24, 0, 0, 0)
        );
      }

      if (req.body.endDate) {
        req.body.endDate = new Date(
          new Date(req.body.endDate).setHours(24, 0, 0, 0)
        );
      }

      if (req.body.holidayDate) {
        req.body.holidayDate = new Date(
          new Date(req.body.holidayDate).setHours(24, 0, 0, 0)
        );
      }
